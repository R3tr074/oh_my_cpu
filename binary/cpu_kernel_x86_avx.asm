.globl cpu_kernel_x86_avx_fp32
.globl cpu_kernel_x86_avx_fp64

cpu_kernel_x86_avx_fp32:
    mov $0x40000000, %rax
...
.cpu.x86.avx.fp32.L1:
    ...
    sub $0x1, %rax
    jne .cpu.x86.avx.fp32.L1
    ret

cpu_kernel_x86_avx_fp64:
    mov $0x40000000, %rax
